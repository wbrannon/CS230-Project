...
function AutomotiveDrivingModels.get_lane_offset(a::LaneChangeChoice, scenes::Vector{Scene}, roadway::Roadway, vehicle_index::Int, pastframe::Int=0)
    if a.dir == 0 # straight
...
function observe!(driver::lat_lon_driver, scene::Scene, roadway::Roadway, egoid::Int)
